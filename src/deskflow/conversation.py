...
from deskflow import activity, context
from deskflow import settings as config
from deskflow.client.factory.monitchat import Monitchat
from deskflow.client.whatsapp_client import WhatsappClient
from deskflow.config import BACK_KEYWORDS, RESTART_CONVERSATION_KEYWORDS
from deskflow.sender_worker import send_message
from deskflow.stage import bot_stage
from deskflow.stage.bot_stage import AskEndStage, AskStartMenuStage
from deskflow.flow_interpreter import get_interpreter_for_msisdn
...
class Conversation:
    ...
    def start(self):
        ...
        from deskflow.models.flow import get_active_flow, get_flow_by_id
        from deskflow.flow_interpreter import get_interpreter_for_flow_id
