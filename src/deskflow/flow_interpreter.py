...
from deskflow.client import vipdesk, support
from deskflow.common import validate_cpf, validate_cnpj, format_cpf
...
Se nenhuma intenção se aplicar, retorne: {{"intent": "none"}}"""
    ...
    def _execute_api_call_node(self, node, msisdn, text, execute_children=True):
        ...
        if api_type == "get_partner":
            ...
            api_response = vipdesk.get_partner(phone=msisdn)
            ...
            customer_data = vipdesk.get_client(cpf=cpf, codparc=codparc)
            ...
            products = vipdesk.get_products(codigo=codparc)
            ...
            services = vipdesk.get_services(codigo=codparc)
    ...
    def _execute_delay_node(self, node, msisdn, text, execute_children=True):
        ...
        from deskflow.sender_worker import execute_delayed_node
    ...
    def _execute_transfer_node(self, node, msisdn, text, execute_children=True):
        ...
        from deskflow.client import support
