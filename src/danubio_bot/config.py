...
SQLALCHEMY_DATABASE_URI = os.getenv(
    "DATABASE_URL",
    ("postgresql://danubio_bot:<SECRET>@172.17.0.1/danubio_bot"),
)
...
DANUBIO_BOLETO_BASE_URL = os.getenv(
    "DANUBIO_BOLETO_BASE_URL",
    "https://boletos.danubio.net.br/api",
)

DANUBIO_API_BASE_URL = os.getenv(
    "DANUBIO_API_BASE_URL",
    "http://danubio-prd.siac.tech/mge/service.sbr",
)

DANUBIO_COMPANY = os.getenv("DANUBIO_COMPANY", "04065234000178")

DANUBIO_PASSWORD = os.getenv("DANUBIO_PASSWORD", "")
DANUBIO_USER = os.getenv("DANUBIO_USER", "")
